...
if r.plotfigures:
    ...
    plot_PSD_with_topomap(fPenta_spec, 'Pentadactyl', topomapF1 [:61, 0, 4], info, ax1)
    plot_PSD_with_topomap(fDeka_spec, 'Dekadactyl', topomapF1 [:61, 1, 4], info, ax2)
    plot_PSD_with_topomap(fCrossP_spec, 'Cross-Pentadactyl', topomapF2 [:61, 3, 4], info, ax3)
    plot_PSD_with_topomap(fCrossDeka_spec, 'Cross-Dekadactyl', topomapF1 [:61, 4, 4], info, ax4)
...
r.EEGF2B_ng1 = EEGF2Bstats3dp[0,6]
