...
for (n in 1:8){tabledata[1,n+2] <- model1params[n]}
for (n in 1:8){tabledata[2,n+2] <- model2params[n]}
tabledata[3,2] <- EEGparams[2]
tabledata[3,5] <- EEGparams[1]
tabledata[3,6] <- EEGparams[3]
tabledata[3,8] <- EEGparams[4]
tabledata[3,9] <- EEGparams[5]
