...
dipperstats[,6] <- round(dipperstats[,6],digits=2)
dipperstats[,9] <- round(dipperstats[,9],digits=3)
dipperstats[,8] <- p_format(dipperstats[,8],digits=3,accuracy=0.001,leading.zero=TRUE)
