            ...
            for pedlevel in range(8):
                if pedlevel < len(pedlevs):  
                    ...
                    if not blockdata.empty:
                        ...
                        allthresh[i, cond - 1, pedlevel] = result.parameter_estimate['threshold']
                        allslope[i, cond - 1, pedlevel] = 10.3 / (result.parameter_estimate['width'] / (norm.ppf(1 - 0.05) - norm.ppf(0.05)))
