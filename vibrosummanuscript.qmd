...
dipperstats[,6] <- round(as.numeric(dipperstats[,6]),digits=2)
dipperstats[,9] <- round(as.numeric(dipperstats[,9]),digits=3)
dipperstats[,8] <- p_format(as.numeric(dipperstats[,8]),digits=3,accuracy=0.001,leading.zero=TRUE)
