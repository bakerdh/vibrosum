            ...
            for pedlevel in range(8):
                if pedlevel < len(pedlevs):  
                    ...
                    if not blockdata.empty:
                        ...
                        result_fit = ps.psignifit(tofit, experiment_type='2AFC', sigmoid='norm')
                        result_params = result_fit.get_parameters_estimate()
                        allthresh[i, cond - 1, pedlevel] = result_params['threshold']
                        allslope[i, cond - 1, pedlevel] = 10.3 / (result_params['width'] / (norm.ppf(1 - 0.05) - norm.ppf(0.05)))
...
if r.fitmodels:
    fitpath = "/content/fits1/"
    
    if not os.path.exists(fitpath):
        os.makedirs(fitpath)
    
    data = np.load('/content/drive/MyDrive/allthresh.npz')
    allthresh= data['allthresh']
    ...
    np.save('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/allpreddB.npy', allpreddB )
    np.save('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/model1Param.npy', model1params )
    ...
    np.save('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/allpreddB2.npy', allpreddB2 )
    np.save('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/model2Param.npy', model2params )
...
if r.fitmodels:
    fitpath = "/content/content/fits2/"
    if not os.path.exists(fitpath):
        os.makedirs(fitpath)
    
    EEGF1 =np.load("/content/drive/MyDrive/Shasha_EEG/allF1.npy")   # 30*6*5
    meanF1=np.mean(EEGF1 , axis=0)  #6*5
    n = meanF1.shape[0]
    stdF1 = np.std(EEGF1, axis=0, ddof=1)
    SEF1 = stdF1/ np.sqrt(n)  #6*5
    
    EEGF2 =np.load("/content/drive/MyDrive/Shasha_EEG/allF2.npy")   # 30*6*5
    ...
    np.save('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/EEG_allresp.npy', allresp )
    np.save('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/EEG_modelparams.npy', modelparams )
...
if plotfigures:
    ...
    allpreddB= np.load('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/allpreddB.npy')
    ...
    allpreddB2= np.load('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/allpreddB2.npy')
    legend_elements2 = []
    for cond, marker in zip(range(4) , markers):
    ...
    allresp = np.load('C:/Users/mfv507/OneDrive - University of York/Documents/Py_Scripts/EEG_allresp.npy')
