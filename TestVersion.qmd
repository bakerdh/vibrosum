...
::: {.content-visible unless-format="docx"}
![Summary of model fitting. Panel (a) shows the fit of a model in which summation is linear (following an early transducer), and panel (b) shows the fit of the Minkowski summation model. Panels (c) and (d) show the best model fit to the EEG data at 26Hz (c) and 23Hz (d).](Figures/Figure3.pdf){#fig-models}
:::
